...
```{r}
string<-"Going to the mall."
#how would you detect a capital letter and period ? 
...
#frequence of occurence of all the unique things in a character
